...
<body>
	<form:form id="form" action="/register"
		modelAttribute="registrationForm" method="post">
		<div class="form_register">
			<table>
				<tr>
					<td colspan="2" align="center"><span class="heading">Registration</span>
					</td>
					<td />
				</tr>
				<tr>
					<td colspan="3" align="center"><span class="error">${error}</span>
					</td>
				</tr>
				<tr>
					<td colspan="3" align="center"><span class="message">${message}</span>
					</td>
				</tr>
				<tr>
					<td><label class="message">Username</label></td>
					<td><form:input cssClass="input" path="username"
							name="username" maxlength="12" /></td>
					<td><form:errors cssClass="error" path="username" /></td>
				</tr>
				<tr>
					<td><label class="message">Password</label></td>
					<td><form:input cssClass="input" path="password"
				...
				<tr>
					...
					<td><form:input cssClass="input" path="confirmPassword"
							type="password" maxlength="18" name="confirmPassword" /></td>
					<td><form:errors cssClass="error" path="confirmPassword" /></td>
				</tr>
				<tr>
					<td><label class="message">First Name</label></td>
					<td><form:input cssClass="input" path="firstName"
							name="firstName" maxlength="30" /></td>
					<td><form:errors cssClass="error" path="firstName" /></td>
				</tr>
				<tr>
					<td><label class="message">Last Name</label></td>
					<td><form:input cssClass="input" path="lastName"
							name="lastName" maxlength="30" /></td>
					<td><form:errors cssClass="error" path="lastName" /></td>
				</tr>
				<tr>
					<td><label class="message">Email</label></td>
					<td><form:input cssClass="input" path="emailId" name="emailId"
							maxlength="30" /></td>
					<td><form:errors cssClass="error" path="emailId" /></td>
				</tr>
				<tr>
					<td><label class="message">Date of Birth</label></td>
					<td><form:input cssClass="input" path="dateOfBirth"
							placeholder="yyyy-MM-dd" maxlength="10" name="dateOfBirth" /></td>
